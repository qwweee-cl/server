...
function error_exp
{
	...
	| mail -s "[test]Slave Countly Batch Error Trap" gary_huang@cyberlink.com,qwweee@gmail.com
	#sleep 1
	rm -f ${LOCKFILE}
	exit 1
}
...
if [ -e ${LOCKFILE} ] ; then
	...
	| mail -s "[test]Slave Countly Batch Already running" gary_huang@cyberlink.com,qwweee@gmail.com
	#sleep 1
	rm -f ${LOCKFILE}
	exit 1
else
...
| mail -s "[test]Slave [$curdate]Countly Batch Finished" gary_huang@cyberlink.com,qwweee@gmail.com
#sleep 1
rm -f ${LOCKFILE}
