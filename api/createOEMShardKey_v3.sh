...
for (( j = 0 ; j < ${#oems[@]} ; j++ )) do
  ...
  echo -e "node ensureEventIndex.js ${dbHost} ${batchdb} raw_event_75edfca17dfbe875e63a66633ed6b00e30adcb92" >> ${one_time_log}
  echo -e "node ensureEventIndex.js ${dbHost} ${batchdb} raw_event_9219f32e8de29b826faf44eb9b619788e29041bb" >> ${one_time_log}
  echo -e "node ensureEventIndex.js ${dbHost} ${batchdb} raw_event_0368eb926b115ecaf41eff9a0536a332ef191417" >> ${one_time_log}
  echo -e "node ensureEventIndex.js ${dbHost} ${batchdb} raw_event_02ce3171f470b3d638feeaec0b3f06bd27f86a26" >> ${one_time_log}
  echo -e "node ensureEventIndex.js ${dbHost} ${batchdb} raw_event_895ef49612e79d93c462c6d34abd8949b4c849af" >> ${one_time_log}
  ...
  node ensureEventIndex.js ${dbHost} ${batchdb} raw_event_9219f32e8de29b826faf44eb9b619788e29041bb
  node ensureEventIndex.js ${dbHost} ${batchdb} raw_event_0368eb926b115ecaf41eff9a0536a332ef191417
  node ensureEventIndex.js ${dbHost} ${batchdb} raw_event_02ce3171f470b3d638feeaec0b3f06bd27f86a26
  node ensureEventIndex.js ${dbHost} ${batchdb} raw_event_895ef49612e79d93c462c6d34abd8949b4c849af
