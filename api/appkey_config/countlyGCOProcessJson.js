import androidJson from './countly_gcp_auto_android_json';
import iosJson from "./countly_gcp_auto_ios_json";
import fs from "fs";
...
const dataFile1 = path.join('./', 'countly_gcp_auto_android_json_code.json');
...
const dataFile2 = path.join('./', 'countly_gcp_auto_ios_json_code.json');
