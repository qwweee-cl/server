...
function error_exp
{
	...
	| mail -s "Clad2 Countly OEM Batch Error Trap" gary_huang@cyberlink.com,qwweee@gmail.com
	#sleep 1
...
| mail -s "[$curdate]Clad2 Countly OEM Batch Finished" gary_huang@cyberlink.com,qwweee@gmail.com
exit 0
## zip backup file
#exit 0
