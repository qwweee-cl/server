...
var dataPath = path.join(__dirname, '.', 'mydata');
var tmpPath = path.join(__dirname, '.', 'mytmp');

var databases = [
	{
		type: 'country',
		//url: 'https://geolite.maxmind.com/download/geoip/database/GeoIPCountryCSV.zip',
		url: 'https://clcom2-countly.s3.amazonaws.com/test/geoip_20170228/GeoIPCountryCSV.zip',
	...
	},
	{
		...
		url: 'https://clcom2-countly.s3.amazonaws.com/test/geoip_20170228/GeoLiteCity.zip',
		src: [
			//'GeoLiteCity-Blocks.csv',
			//'GeoLiteCity-Location.csv'
			'GeoIPCity-134-Blocks.csv',
			'GeoIPCity-134-Location.csv'
		],
		dest: [
			'geoip-city.dat',
...
async.eachSeries(databases, function(database, nextDatabase) {
	...
	if (err) {
		...
		else console.log('test');//rimraf(tmpPath);
		process.exit(0);
	}
});
