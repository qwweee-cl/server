...
function error_exp
{
	...
	| mail -s "[test]Clad YMK Event Error Trap" gary_huang@cyberlink.com,qwweee@gmail.com
	#sleep 1
	exit 0
}
...
cmd="node saveTest1Mysql.js &"
echo -e $cmd
$cmd
cmd="node saveTest2Mysql.js &"
echo -e $cmd
$cmd
#node processData.js
...
| mail -s "[test][$nowDate]Clad YMK Event Finished" gary_huang@cyberlink.com,qwweee@gmail.com
