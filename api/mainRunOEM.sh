...
function error_exp
{
	...
	| mail -s "Main Countly OEM Batch Error Trap" gary_huang@cyberlink.com,qwweee@gmail.com
	#sleep 1
...
| mail -s "Main [$curdate]Countly OEM Batch Finished" gary_huang@cyberlink.com,qwweee@gmail.com
## zip backup file
#exit 0
